...
class Ranklist extends Component {
   constructor(props){
    ...
    componentDidMount(){
       ...
       axios.get(`http://localhost:88/rankings/${this.props.match.params.contestCode}/${userName}`)
         .then(res => {
    ...
    render() {
       if(this.state.loaded){
         ...
         return(
            <div style={{border:'solid black 5px', height:'350px', paddingTop:'350px', width:'963px', fontSize:'30px'}}>

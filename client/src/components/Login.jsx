...
class login extends Component {
  ...
  render() {
    return (
      <div style={{paddingTop:'150px', height:'450px', border:'solid black 5px'}}>
        <div>
          <Welcome />
          <button style={style} onClick={this.handleClick}>Login With Codechef</button>
          {this.state.status && <div style={{backgroundColor:'#d94d65'}}><strong>Something went wrong ! Please Login again </strong></div>}
        </div>
      </div>
    );
  }
